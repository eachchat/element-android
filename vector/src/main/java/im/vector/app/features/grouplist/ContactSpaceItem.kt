...
abstract class ContactSpaceItem : VectorEpoxyModel<ContactSpaceItem.Holder>() {
    ...
    override fun bind(holder: Holder) {
        ...
        holder.groupNameView.text = holder.view.context.getString(R.string.contacts_book)
        ...
        holder.avatarImageView.setImageResource(R.drawable.ic_drawer_contact)
