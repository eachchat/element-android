 ...
 */
//不需要设置session的webView activity
@AndroidEntryPoint
class NormalWebViewActivity : VectorBaseActivity<ActivityVectorWebViewBinding>() {
    ...
    companion object {
        ...
        fun getIntent(context: Context,
            ...
            return Intent(context, NormalWebViewActivity::class.java)
                    .apply {
