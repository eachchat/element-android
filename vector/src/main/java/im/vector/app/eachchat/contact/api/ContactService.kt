...
import im.vector.app.eachchat.contact.api.bean.ContactIncrementBean
...
import im.vector.app.eachchat.contact.api.bean.ContactRoomBean
import im.vector.app.eachchat.contact.api.bean.ContactSettingsResult
import im.vector.app.eachchat.contact.api.bean.MatrixIdBean
import im.vector.app.eachchat.contact.api.bean.RemarkName
import im.vector.app.eachchat.contact.data.ContactsDisplayBean
import im.vector.app.eachchat.contact.data.ContactsRoom
import im.vector.app.eachchat.contact.data.EnterpriseSettingEntity
