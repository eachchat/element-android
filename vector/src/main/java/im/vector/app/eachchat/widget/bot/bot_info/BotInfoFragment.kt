...
class BotInfoFragment @Inject constructor(
        private val roomMemberProfileController: BotInfoProfileController,
        private val avatarRenderer: AvatarRenderer,
        private val matrixItemColorProvider: MatrixItemColorProvider
) : VectorBaseFragment<FragmentMatrixProfileBinding>(),
        BotInfoProfileController.Callback {

    private lateinit var headerViews: ViewStubRoomMemberProfileHeaderBinding

    private val fragmentArgs: BotInfoArg by args()
    private val viewModel: BotInfoViewModel by fragmentViewModel()
