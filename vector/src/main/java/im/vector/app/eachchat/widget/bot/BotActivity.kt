...
@AndroidEntryPoint
class BotActivity: VectorBaseActivity<ActivityFragmentContainerBinding>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        replaceFragment(views.fragmentContainer, BotFragment::class.java, params)
    }

    companion object {
        fun start(context: Context,
        ) {
            val intent = Intent(context, BotActivity::class.java)
