...
import im.vector.app.eachchat.contact.ContactSyncUtils.Companion.getInstance
import im.vector.app.eachchat.database.AppDatabase.Companion.getInstance
...
import im.vector.app.eachchat.contact.data.IncrementUpdateInput
...
import im.vector.app.eachchat.contact.event.UpdateUserEvent
import im.vector.app.eachchat.contact.event.UpdateUserCompleteEvent
import im.vector.app.eachchat.contact.api.bean.Department
import im.vector.app.eachchat.contact.data.User
import im.vector.app.eachchat.contact.event.UpdateDepartmentEvent
