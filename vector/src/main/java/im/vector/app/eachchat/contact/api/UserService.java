...
import im.vector.app.eachchat.contact.api.bean.AvatarUploadBean;
import im.vector.app.eachchat.contact.api.bean.BindDeviceInput;
import im.vector.app.eachchat.contact.api.bean.Department;
import im.vector.app.eachchat.contact.api.bean.DepartmentInput;
import im.vector.app.eachchat.contact.api.bean.LoginInput;
