...
@AndroidEntryPoint
class MoreInfoActivity : VectorBaseActivity<ActivitySimpleBinding>() {

    companion object {
        fun start(context: Context, args: UserInfoArg) {
    ...
    override fun initUiAndData() {
        if (isFirstCreation()) {
            val fragmentArgs: UserInfoArg = intent?.extras?.getParcelable(Mavericks.KEY_ARG) ?: return
            addFragment(views.simpleFragmentContainer, MoreInfoFragment::class.java, fragmentArgs)
        }
