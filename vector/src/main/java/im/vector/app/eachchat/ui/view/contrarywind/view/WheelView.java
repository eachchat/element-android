package im.vector.app.eachchat.ui.view.contrarywind.view;
...
import im.vector.app.eachchat.ui.view.contrarywind.interfaces.IPickerViewData;
import im.vector.app.eachchat.ui.view.contrarywind.listener.LoopViewGestureListener;
import im.vector.app.eachchat.ui.view.contrarywind.listener.OnItemSelectedListener;
import im.vector.app.eachchat.ui.view.contrarywind.timer.InertiaTimerTask;
import im.vector.app.eachchat.ui.view.contrarywind.timer.MessageHandler;
import im.vector.app.eachchat.ui.view.contrarywind.timer.SmoothScrollTimerTask;
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            // angle [-90°,90°]
            float angle = 0;//item第一项,从90度开始，逐渐递减到 -90度

            // 计算取值可能有细微偏差，保证负90°到90°以外的不绘制
            if (angle > 80F || angle < -80F || radian < Math.PI / 12 || radian > Math.PI * 13 / 12 ) {
                canvas.restore();
            } else {
                //获取内容文字
                String contentText;
